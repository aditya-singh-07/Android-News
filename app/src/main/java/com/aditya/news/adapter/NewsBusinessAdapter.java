...
public class NewsBusinessAdapter extends RecyclerView.Adapter<NewsBusinessAdapter.BusinessviewHolder> {
    Context context;
    private List<Article> articles;

    public NewsBusinessAdapter(Context context, List<Article> articles) {
    ...
    @NonNull
    @Override
    public NewsBusinessAdapter.BusinessviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.latest,parent,false);
        return new NewsBusinessAdapter.BusinessviewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewsBusinessAdapter.BusinessviewHolder holder, int position) {
