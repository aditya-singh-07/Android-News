...
public class NewsLatestAdapter extends RecyclerView.Adapter<NewsLatestAdapter.Latestviewholder> {
    Context context;
    private List<Article> articles;

    public NewsLatestAdapter(Context context, List<Article> articles) {
