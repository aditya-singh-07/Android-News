...
public class NewsTechnologyAdapter extends RecyclerView.Adapter<NewsTechnologyAdapter.TechnologyviewHolder> {
    Context context;
    private List<Article> articles;

    public NewsTechnologyAdapter(Context context, List<Article> articles) {
